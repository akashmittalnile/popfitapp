                ...
                <View style={{ paddingBottom: 70 }}>
                  ...
                  <View>
                    <View style={{ height: 60 }}>
                      <Text style={{ marginLeft: 25, marginTop: 20, textAlign: 'left', fontSize: 14, color: 'black', fontWeight: "bold" }}>{subcategoryBlogdetailsitems?.blog_detail?.youtube_title}</Text>
                    </View>
                    <View style={{
                    ...
                    <Text style={{ marginHorizontal: 20, marginTop: 10, textAlign: 'left', fontSize: 11, color: '#000', }}>{subcategoryBlogdetailsitems?.blog_detail?.youtube_description}</Text>

                    <Text style={{ marginLeft: 20, textAlign: 'left', marginTop: 20, fontSize: 14, color: '#000', fontWeight: "bold" }} >{subcategoryBlogdetailsitems?.blog_detail?.image_title}</Text>
                    ...
                    <Text style={{ marginHorizontal: 20, marginTop: 20, textAlign: 'left', fontSize: 11, color: '#000', }}>{subcategoryBlogdetailsitems?.blog_detail?.image_description}</Text>
                  </View>
