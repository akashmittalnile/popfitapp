...
const ShippingDetail = props => {
        ...
        SetAddrs:
          setselectaddress == null
            ? address?.address_type +
              ...
              ',' +
              address?.phone
            : setselectaddress?.address_type +
              ',' +
              setselectaddress?.full_name +
              ',' +
              setselectaddress?.house_no +
              ',' +
              setselectaddress?.area_village +
              ',' +
              setselectaddress?.city +
              ',' +
              setselectaddress?.landmark +
              ',' +
              setselectaddress?.state +
              ',' +
              setselectaddress?.pincode +
              ',' +
  ...
  const ProductRemovecart = async item => {
    ...
    try {
      const response = await axios.post(
        `${API.PRODUCT_DETAILS_REMOVE_ITEM} `,
        {cart_id: cartremoveid},
        {
          headers: {Authorization: ` ${usertkn}`},
        },
      );
      ...
      {!isLoading ? (
        <ScrollView
                ...
                return (
                  <TouchableOpacity
                    ...
                    <View
                      ...
                      <TouchableOpacity
                        onPress={() => ProductRemovecart(item)}
                        style={{
                          position: 'absolute',
                          backgroundColor: 'red',
                          width: 30,
          ...
          <View
            ...
            <>
              <View
                style={{height: 105, width: WIDTH * 0.95, borderRadius: 20}}>
                <View
                          ...
                          <View
                            ...
                            <View
                              ...
                              <Text
                                ...
                                {address?.full_name}, {address?.house_no},{' '}
                                {address?.area_village}, {address?.city},
