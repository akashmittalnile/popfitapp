        ...
        (<View>
         <Headers
          ...
          <ScrollView>
            ...
            <Text style={{ marginLeft: 25, marginTop: 20, textAlign: 'left', fontSize: 14, color: 'black', }}>Fitness Equipment</Text>
            <FlatList
              ...
              renderItem={({ item, index }) => (
                <TouchableOpacity onPress={() => { gotoDumbleSet() }}>
                  ...
                  <BackgroundImage
                    ...
                    <View style={{ width: 100, backgroundColor: '#c9bca0', height: 20, borderBottomRightRadius: 10, justifyContent: 'center' }}>
                      <Text style={{ textAlign: 'center', fontSize: 9, color: 'black', }}>Sub-Category 1</Text>
                    </View>
