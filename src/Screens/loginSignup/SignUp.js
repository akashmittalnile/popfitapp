...
import { View, Text, TouchableOpacity, StyleSheet, TextInput, Image, Alert, Pressable, Modal, Button, ActivityIndicator, ViewPropTypes, } from 'react-native'
                  ...
                  <View style={style.textContainer}>
                    <View style={{ flexDirection: 'column', }}>
                      <View style={{ flexDirection: 'row', justifyContent: "center", alignItems: "center" }}>
                        ...
                        />
                        <TouchableOpacity onPress={() => { setcalmodal(true), console.log(",,,,", calmodal) }}
                          style={{
                    ...
                    <View style={{ flexDirection: 'column', }}>
                      ...
                      {
                        msgcountry ?
                          <View style={{ justifyContent: "center", alignItems: "flex-start", marginTop: 8, paddingLeft: 50, }}>
                            <Text style={{
                              fontSize: 12,
                              color: '#FF0D10',
                    ...
                    <View style={{ flexDirection: 'column', marginTop: 8 }}>
                      ...
                      {touched.password && errors.password &&
                        <Text style={{ fontSize: 12, color: '#FF0D10', paddingLeft: 30, }}>{errors.password}</Text>
                      }
                    </View>
                    ...
                    <View style={{ flexDirection: 'column', marginTop: 14 }}>
                      ...
                      {touched.cfm_password && errors.cfm_password &&
                        <Text style={{ fontSize: 12, color: '#FF0D10', paddingLeft: 30, }}>{errors.cfm_password}</Text>
                      }
                    </View>
