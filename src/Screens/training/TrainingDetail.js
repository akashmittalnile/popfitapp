...
const TrainingDetail = props => {
  ...
  const workoutCategoryAPI = async () => {
    const usertkn = await AsyncStorage.getItem('authToken');
    console.log("USER_TOKEN", usertkn);
    setIsLoading(true);
    try {
              ...
              <Pages indicatorColor="#ffcc00">
                <View
                  ...
                  <View
                    ...
                    <Image
                      source={require('../assets/trainningLogo.png')}
                      style={{
                        alignSelf: 'center',
                        width: '100%',
                        height: '100%',
                      ...
                      <View
                        ...
                        <View
                          ...
                          <Text
                            ...
                            {item?.cat_name?.length >= 26
                              ? item?.cat_name?.slice(0, 26) + '...'
                              : item?.cat_name?.slice(0, 26)}
                          </Text>
                        </View>
                        <View
                        ...
                        <View
                          ...
                          <Text
                            ...
                            {t('Subscription')} {item?.plan_name} {t('Plan')}{' '}
                          </Text>
                        </View>
                      </View>
                    </TouchableOpacity>
