...
const MenuFieldState = ({ visible, placeHolder, showMenu, hideMenu, selectAction, data, title, style, }) => {
                                ...
                                data.map((item, index1) =>
                                    <View key={index1}>
                                        ...
                                        <MenuItem
                                            ...
                                            onPress={() => {
                                                hideMenu();
                                                selectAction(item.city_name, item.id);
                                            }}>
                                            <Text style={{ marginLeft: "8%", fontSize: 17, color: Colors.black }}>{item.city_name}</Text>
                                        </MenuItem>
                                    </View>
